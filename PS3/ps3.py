...
def get_word_score(word, n):
    ...
    first_component =0
    for i in word:
        first_component=SCRABBLE_LETTER_VALUES.get(i,0)+first_component
...
def is_valid_word(word, hand, word_list):
    ...
    if word in word_list:
        for letter in word:
            if frequency.get(letter,0) > hand.get(letter, 0):
                is_valid = "False"
                break
            else:
                is_valid = "True"
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while calculate_handlen(hand) > 0:
        ...
        if word != "!!":
            word_valid = is_valid_word(word, hand, load_words())
            if word_valid == "True":
...
def play_game(word_list):
    ...
    * Returns the total score for the series of hands
    ...
    print('Play game not implemented')
